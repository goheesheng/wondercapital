...
const ReadyToLuanch = ({ ReadyToLuanchSecRef }: any) => {
  const t = useTranslations("WonderSetup");

  return (
    <section
      ref={ReadyToLuanchSecRef}
      className="py-8 lg:py-14 px-4 opacity-0 transition-all duration-1000"
      id="contact"
    >
      <div className="max-w-7xl mx-auto">
        <div className="bg-[url('/assets/slider2.png')] bg-cover bg-center rounded-2xl overflow-hidden">
